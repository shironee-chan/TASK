...
<span class="text-danger"><?=form_error('purok')?></span>
      ...
      <div class="form-group col-md-2">
        ...
        <select id="municipality" name="municipality" value="<?php echo $resident_data->municipality; ?>" id="municipality" class="form-control" required>
...
<form method="POST">
      ...
      <div class="form-group col-md-2">
        ...
        <input type="text" id="fullname" name="fullname" value="<?php echo $resident_data->fullname; ?>" id="fullname" class="form-control"/>
